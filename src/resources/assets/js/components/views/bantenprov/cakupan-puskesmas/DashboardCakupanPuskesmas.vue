          ...
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <cakupan-puskesmas-bar-03></cakupan-puskesmas-bar-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
        ...
        <div class="card card-media text-white bg-success">
          <div class="card-body">
            <div class="media">
              <div class="media-body text-truncate">
                <div class="card-body">
                  <cakupan-puskesmas-pie-03></cakupan-puskesmas-pie-03>
                </div><!-- /.card-body -->
              </div>
            </div>
          </div><!-- /.card-body -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Cakupan Cakupan Puskesmas Berdasarkan Wilayah
            </div>
            <div class="card-body">
              <cakupan-puskesmas-bar-01></cakupan-puskesmas-bar-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
        ...
        <div class="col-md-4">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <cakupan-puskesmas-pie-01></cakupan-puskesmas-pie-01>
            </div><!-- /.card-body -->
          </div><!-- /.card -->
      ...
      <div class="col-md-4">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-pie-chart" aria-hidden="true"></i>
            Cakupan Cakupan Puskesmas Berdasarkan Tahun
          </div>
          <div class="card-body">
            <cakupan-puskesmas-pie-02></cakupan-puskesmas-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /.col -->
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <cakupan-puskesmas-bar-02></cakupan-puskesmas-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
